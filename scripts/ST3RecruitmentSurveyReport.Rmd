...
survey <- read_sheet("https://docs.google.com/spreadsheets/d/14LmXkStaruBSxjz9IrTAh3T-rPczayQDy-J5Jdnb8X0/edit?usp=sharing")
...
# Remove email identifier and save raw data
survey_export <- survey %>% select(-DoYouConsentToBeContactedInTheFutureViaEmailIfSoPleaseProvideYourEmailAddress)
write_csv(survey_export, "../data/survey_data_raw.csv")
